...
self.addEventListener('push', (e) => {
  ...
  const opciones = {
    ...
    // "silent" explícito en false y "vibrate" ayudan a que Android/el
    // navegador reproduzcan el sonido/vibración por defecto de la
    // notificación en vez de dejarla en un estado silencioso ambiguo.
    silent: false,
    vibrate: [200, 80, 200]
  };
